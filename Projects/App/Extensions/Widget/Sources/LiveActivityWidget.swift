...
struct LiveActivityWidget: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: AlarmAttributes<StudyAlarmMetadata>.self) { context in
            ...
            DynamicIsland {
                ...
                DynamicIslandExpandedRegion(.trailing) {
                    studySubtitle(metadata: context.attributes.metadata)
                }
...
//                                  tint: context.attributes.tintColor)
    ...
    func lockScreenView(attributes: AlarmAttributes<StudyAlarmMetadata>, state: AlarmPresentationState) -> some View {
        VStack {
            HStack(alignment: .top) {
                alarmTitle(attributes: attributes, state: state)
                Spacer()
                studySubtitle(metadata: attributes.metadata)
            }
    ...
    func bottomView(attributes: AlarmAttributes<StudyAlarmMetadata>, state: AlarmPresentationState) -> some View {
        HStack {
    ...
    @ViewBuilder func alarmTitle(attributes: AlarmAttributes<StudyAlarmMetadata>, state: AlarmPresentationState) -> some View {
    ...
    @ViewBuilder func studySubtitle(metadata: StudyAlarmMetadata?) -> some View {
